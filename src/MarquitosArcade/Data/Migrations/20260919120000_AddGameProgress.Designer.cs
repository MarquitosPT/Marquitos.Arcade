...
namespace MarquitosArcade.Data.Migrations
{
    ...
    [Migration("20260919120000_AddGameProgress")]
    partial class AddGameProgress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarquitosArcade.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MarquitosArcade.Data.GameProgressEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MarquitosArcade.Data.ScoreEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MarquitosArcade.Data.ApplicationUser", null)
                        .WithMany()
